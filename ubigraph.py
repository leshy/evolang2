...
class Ubigraph:
  def __init__(self, URL='http://10.0.0.5:20738/RPC2'):
...
class EdgeStyle:
  def __init__(self, U, parentStyle=None, id=None, arrow=None, color=None,
             label=None, fontcolor=None, fontfamily=None, fontsize=None,
             oriented=None, spline=None, showstrain=None, stroke=None,
             strength=None, visible=None, width=None, arrow_position=None,arrow_length=None,arrow_radius=None):
    self.U = U
    parentStyle2 = parentStyle
  ...
  def set(self, arrow=None, color=None,
             label=None, fontcolor=None, fontfamily=None, fontsize=None,
             oriented=None, spline=None, showstrain=None, stroke=None,
             strength=None, visible=None, width=None,arrow_position=None,arrow_length=None,arrow_radius=None,arrow_reverse=None):
    if arrow != None:
